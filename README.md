...
```shell
ext install vsc-soothing-green
```
...
Clone the Soothing Green Theme repository as `Soothing Green`:

```shell
git clone https://github.com/Kumar21/ThemeForVSCode.git Soothing Green Theme
```
...
<p align="center"> Copyright &copy; © 2018 Microsoft </p>
